...
//学校信息
var schoolUrl = "index.php?app=Pufinance&mod=SchoolVoteWx&act=lists";

//统计
var tongji = "index.php?app=Pufinance&mod=SchoolVoteWx&act=pv";

//数据
var info = "index.php?app=Pufinance&mod=SchoolVoteWx&act=stat";
    ...
    var index = new Vue({
        ...
        methods: {
            init: function () {
                ...
                //统计的数据
               this.info = new util.AjaxVue(info, {}, false, this.info).getobj();
            ...
            goSchool : function (sid) {
                window.location.href = schoolInfoUrl + '&sid=' + sid;
            },
            follow : function(dom){
                ...
                if($(".footer_Follow").data("client") =="app"){
                    ...
                    window.location.href = 'index.php?app=Pufinance&mod=SchoolVoteWx&act=follow';
                }
